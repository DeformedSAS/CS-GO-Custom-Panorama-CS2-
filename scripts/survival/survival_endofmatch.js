...
( function ()
{
    ...
    function _UpdateStats( oLocalPlayer, oInfo )
    {
        ...
        if ( oLocalPlayer )
        {
            if ( oLocalPlayer.position_loc.slice( 0, 1 ) === '#' )
                _m_cP.FindChildInLayoutFile( 'id-stat-position' ).SetLocalizationString( oLocalPlayer.position_loc );
            else
            ...
            _m_cP.FindChildInLayoutFile( 'id-stat-title' ).SetLocalizationString( oLocalPlayer.alive_loc );
    ...
    function _AddStatsRow ( elStats, oStat ) 
    {
        ...
        elPanel.FindChildInLayoutFile( 'id-stat-name' ).SetLocalizationString( oStat.name );
        ...
        elPanel.FindChildInLayoutFile( 'id-stat-value' ).SetLocalizationString( oStat.value_loc );
    }
