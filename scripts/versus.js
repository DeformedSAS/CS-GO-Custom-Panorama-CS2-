...
var Versus = (function() {
	...
	function _Init(mockdata) {
		...
		_m_elPreviewPanel_MyTeam.SetScene("resource/ui/econ/VersusCharactersMine.res", 'models/player/custom_player/legacy/ctm_sas.mdl', false);
    ...
    function _SelectScene() {
        ...
        if (!_m_oPlayersData || !_m_oPlayersData.scene || !_m_oPlayersData.allplayerdata || !_m_oPlayersData.allplayerdata.length)
            return true;
        ...
        for (var j = 0; j < _m_oPlayersData.allplayerdata.length; ++j) {
            ...
            switch (_m_oPlayersData.allplayerdata[j].teamnumber) {
                case 2:
                    teamnameForPlayer = 'TERRORIST';
                    break;
                case 3:
                    teamnameForPlayer = 'CT';
                    break;
            }
    ...
    function _Show(teamOverride = undefined) {
        ...
        $.Schedule(_m_totalTime - teamFadeOutDuration, function() {
            _m_elPreviewPanel_MyTeam.AddClass('fade-out');
            _m_elPreviewPanel_MyTeam.style.animationDuration = teamFadeOutDuration + 's';
        });
